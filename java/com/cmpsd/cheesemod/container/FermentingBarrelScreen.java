...
public class FermentingBarrelScreen extends ContainerScreen<FermentingBarrelContainer> {
	...
	private static final ResourceLocation FERMENTINNG_BARREL_GUI_TEXTURES = new ResourceLocation(CheeseMod.MODID, "textures/gui/container/block_fermenting_barrel.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		this.minecraft.getTextureManager().bindTexture(FERMENTINNG_BARREL_GUI_TEXTURES);
		int i = this.guiLeft;
		int j = this.guiTop;
